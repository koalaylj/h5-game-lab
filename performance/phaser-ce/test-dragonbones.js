function main() {
  ...
  this.preload = function() {
    ...
    game.load.json('man_json', '../assets/dragonbones/man_tex.json');
    game.load.image('man_tex', '../assets/dragonbones/man_tex.png');
    game.load.json('man_ske','../assets/dragonbones/man_ske.json');
  };
  ...
  this.create = function() {
    ...
    factory.parseTextureAtlasData(
      game.cache.getJSON("man_json"),
      game.cache.getImage("man_tex", true).base
    );
    this.armatureDisplay = factory.buildArmatureDisplay("man", "man");
    this.armatureDisplay.animation.play("idle");
    this.armatureDisplay.x = 140.0;
    this.armatureDisplay.y = 730.0;
    layers.front.addChild(this.armatureDisplay);
  };
