...
Main.Boot.prototype = {
    ...
    create: function () {
        ...
        //background image
        var background = this.add.image(game.width / 2, game.height / 2, 'background');
    ...
    getSymbolsByIds: function (symbolIds) {
        var symbols = [];
...
var controller = (function () {
    ...
    function create() {
        ...
        _btnBetSub = game.add.button(-660, -40, "main",
            function () {}, this, "btn_minus_pass", "btn_minus_default", "btn_minus_push", "btn_minus_default", _btnGroup);
        _btnBetSub.anchor.setTo(0.5, 0.5);

        //增加投注
        _btnBetAdd = game.add.button(-480, -40, "main",
            function () {}, this, "btn_plus_pass", "btn_plus_default", "btn_plus_push", "btn_plus_default", _btnGroup);
        ...
        _btnMaxBet = game.add.button(-127, 0, "i18n",
            function () {}, this, "btn_maxbet_pass", "btn_maxbet_default", "btn_maxbet_push", "btn_maxbet_default", _btnGroup);
        ...
        _btnAutoPlay = game.add.button(156, 1, "i18n",
            function () {}, this, "btn_autoplay_pass", "btn_autoplay_default", "btn_autoplay_push", "btn_autoplay_default", _btnGroup);
        _btnAutoPlay.anchor.setTo(0.5, 0.5);

        _btnPaytable = game.add.button(579, 32, "i18n",
            function () {}, this, "btn_paytable_pass", "btn_paytable_default", "btn_paytable_push", "btn_paytable_default", _btnGroup);
