...
loader
  ...
  .add("ugly", "../assets/spine/xqz.json")
  .use((res, next) => {
  ...
  .load((loader, res) => {
    ...
    //spine
    var ugly = new PIXI.spine.Spine(res.ugly.spineData);
    ugly.x = 250;
    ugly.y = 500;
    layer.front.addChild(ugly);
    if (ugly.state.hasAnimation('animation')) {
        // run forever, little boy!
        ugly.state.setAnimation(0, 'animation', true);
        // dont run too fast
